...
return [
    ...
    | and it will se application name defined from EduResultChain settings page.
    |
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Force SSL for the application
    |--------------------------------------------------------------------------
    |
    | Force SSL for the whole application.
    |
    */

    'force_ssl' => (bool) env('FORCE_SSL', false),
